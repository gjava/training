...
form.addEventListener("submit", function (e) {
  e.preventDefault(); //const listItems = list.querySelectorAll(".ajax-section .city");

  var inputVal = input.value; //Jquery request
